...
(function($) {
	...
	buildItems = function($this, data, settings) {
        ...
        /***************************************************
         * my modifications..rohit
         * earlier it was
         *   if ($.isArray(str)) {
         *    str = str.join('');
         *    }
         *    in order to get less number of list items I had to change thizs
         *    also added a paramter numListElements  to control the number of items in the list
         ***************************************************************/

		if ($.isArray(str)) {
            if(str.length>settings.numListElements)
            {
                var temp='';
                for(var ii=0;ii<settings.numListElements;ii++)
                {
                    temp=temp+str[ii]+'';
                }
                str=temp;
